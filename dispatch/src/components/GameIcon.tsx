...
export default function GameIcon({ name, size = 32, className = '' }: {
    ...
    const common = { stroke: '#080b0b', strokeWidth: 1.75, strokeLinejoin: 'miter' as const };
    ...
    {name === 'password' && <g {...common}><path fill="none" stroke="#080b0b" strokeWidth="5.5" d="M10 15V9a6 6 0 0 1 12 0v6"/><path fill="none" stroke="#bdb8a6" strokeWidth="2" d="M10 15V9a6 6 0 0 1 12 0v6"/><path fill="#bdb8a6" d="M5 14h22v16H5z"/><path fill="#252a29" d="M14 19h4v4h-1v4h-2v-4h-1z"/></g>}
    ...
    {name === 'shield' && <g {...common}><path fill="#aa7667" d="m16 2 12 5v12l-4 7-8 5-8-5-4-7V7z"/><path fill="#c9bc9f" d="M11 14h10v10H11z"/><path fill="none" stroke="#080b0b" strokeWidth="4" d="M13 14v-3a3 3 0 0 1 6 0v3"/><path fill="none" stroke="#c9bc9f" strokeWidth="1.5" d="M13 14v-3a3 3 0 0 1 6 0v3"/></g>}
    {name === 'music' && <g {...common} fill="#bdb7a0"><path d="M13 5v20h4V11l10-2v12h4V1z"/><ellipse cx="10" cy="26" rx="7" ry="5"/><ellipse cx="24" cy="22" rx="7" ry="5"/></g>}
  </svg>;
}
