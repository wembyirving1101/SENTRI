...
Use case: stylized-concept. Create one standalone transparent game sprite of ONLY the spiral employee HANDBOOK from the LEFT of reference image. Reference supplies exact camera angle, muted colors and pixel art style. Reconstruct complete book silhouette cleanly at high resolution, no desk/background or other objects. This is a PORTRAIT-format thick handbook resting on its bottom edge and leaning back on a hidden support, NOT lying flat viewed from overhead. Front cover tall, width about 80% of height; slightly trapezoid, top edge subtly narrower than bottom, like reference. Camera centered straight ahead with a modest downward angle (about 20 degrees), no sideways rotation. Warm muted tan worn cover, seven thick black spiral rings on left, colored tabs on right, visible layered paper thickness at lower edge and narrow right edge, heavy dark outline. Cover text exactly 'EMPLOYEE' then 'HANDBOOK', dark shield emblem below, small decorative lines at bottom. Match reference understated lighting from upper left, shaded bottom and right, crisp pixel stepped contours and broad tonal planes, not photorealistic or fuzzy. Complete book with transparent padding all sides, alpha background, NO rectangular screenshot patch, NO table, no cast shadow baked onto opaque background.
